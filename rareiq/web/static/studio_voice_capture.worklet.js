...
class StudioVoiceCapture extends AudioWorkletProcessor {
  constructor() {
    ...
    this.voiced=0;this.quiet=0;this.active=false;this.waitQuiet=false;this.lastVoiceTime=0;this.heartbeat=0;
  ...
  frameReady(time) {
    ...
    this.port.postMessage({type:'utterance',wav:buffer,endedContextTime:this.lastVoiceTime},[buffer]);this.clear();
  }
