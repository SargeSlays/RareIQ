...
async function captureCamera(){
  ...
  try{
    ...
    if(result.ok){
      ...
      setCameraStatus("CAPTURE SAVED","var(--green)");
      setRecognitionState("captured",file);
      showCaptureBanner(true,"CAPTURE SAVED",file);
      notify("Capture Saved",file,"success");
      addActivity("Manual Capture Saved",file);
    }else{
