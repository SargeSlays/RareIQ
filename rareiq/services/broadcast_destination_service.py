...
class BroadcastDestinationService:
    ...
    PLATFORMS = (
        ...
        BroadcastPlatform(
            ...
            ("encoder destination",),
            "conditional",
            "TikTok's public developer products do not expose general LIVE route or status APIs.",
            ...
            "No supported TikTok developer API currently supplies LIVE ingest or status evidence.",
        ),
        BroadcastPlatform(
            "x",
            "X",
            "Media Studio Producer / RTMP",
            "Local Media Studio source route",
            ("exact encoder route",),
            "first",
            "X Media Studio source-route monitor not configured.",
            ("X Media Studio Producer access", "RTMP or RTMPS source URL", "Source stream key configured in OBS"),
            "Set the local X route environment, configure OBS, and check status.",
            "Exact OBS source URL/key confirmation; X does not expose general read-only Producer live status.",
        ),
        BroadcastPlatform(
            "instagram",
            "Instagram",
